      ...
      <PageSection background="light" padding="default">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            A coordinated system of specialized AI agents that mirrors your revenue org — from first touch to closed-won and renewal.
          </p>
          ...
          <p
            ...
            data-aos-delay="150"
          >
            ConversionIQ isn&apos;t a single bot. It&apos;s a virtual C-Suite of agents that enrich data, personalize journeys, and execute 1-to-1 conversations across Web-Chat, SMS, WhatsApp, and Social — all grounded in your playbooks and tethered to your existing stack.
          </p>
        </div>
      </PageSection>
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 mb-3">
        <div
          className="w-12 h-12 bg-gradient-to-br from-[#383299]/10 to-[#ef2d60]/10 rounded-lg flex items-center justify-center flex-shrink-0"
          style={{
            fontSize: '20px',
            fontWeight: 600,
            color: '#383299',
...
function GovernanceControlSection() {
  const governancePoints = [
    'SOC2 Type II certified infrastructure with strict tenant-level data segregation.',
    'Pursuing ISO 42001 alignment for AI Management Systems and governance.',
    'Field-level permissions and role-based access for marketing, sales, support, and operations.',
    'Comprehensive transcript logs, configuration history, and audit trails for every decision and override.',
    'Documented data retention and deletion policies aligned with CCPA and GDPR requirements.',
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {governancePoints.map((point, index) => (
            <div
              key={index}
              className="flex items-start gap-4 bg-white border border-[#E5E7EB] rounded-xl p-6"
              style={{
                borderRadius: '12px',
                boxShadow: '0 1px 3px rgba(0, 0, 0, 0.05)',
              }}
            ...
            >
              <div
                className="flex-shrink-0 w-6 h-6 rounded-full bg-[#14B8A6] flex items-center justify-center mt-0.5"
                style={{
                  fontSize: '12px',
                  color: '#FFFFFF',
                }}
